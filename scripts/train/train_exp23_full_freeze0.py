# exp23 — full dataset, freeze=0 (full network; main experiment, replaces exp20)
from ultralytics import YOLO

BASE_WEIGHTS = (
    "/home/talt_wireten_c/road-segmentation/runs/segment/"
    "exp23_full_freeze02/weights/last.pt"
)
...
model.train(
    ...
    workers=24,
    device=2,
    name="exp23_full_freeze0",

    # Full network — same very-low LR strategy as exp20
    freeze=0,
    optimizer="SGD",
    lr0=0.00005,
    lrf=0.01,
