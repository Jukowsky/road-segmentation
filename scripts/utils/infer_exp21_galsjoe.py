...
VVIS_DIR             = "/home/talt_wireten_c/road-segmentation/datasets/Gålsjö_SE_STA_CAMERA_Geni_4503_K1"
OUTPUT_DIR           = "rcm_sample_predictions/exp21_final_galsjoe"
NUM_IMAGES           = 999
CONF_THRESH          = 0.20
IOU_THRESH           = 0.50
...
print(f"Found {len(all_images)} images → {OUTPUT_DIR}")
...
for img_path in all_images:
    ...
    cv2.putText(banner, f"Exp21 (freeze=5, epoch 99 best) — Galsjoe — {img_path.name}",
                (w + 8, 22), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (100, 200, 255), 1, cv2.LINE_AA)
